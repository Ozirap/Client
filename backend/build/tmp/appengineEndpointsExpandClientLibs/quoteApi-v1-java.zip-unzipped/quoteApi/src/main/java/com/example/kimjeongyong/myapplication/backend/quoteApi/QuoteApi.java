 ...
 * on 2016-05-29 at 12:26:22 UTC 
 * Modify at your own risk.
 */

package com.example.kimjeongyong.myapplication.backend.quoteApi;
...
public class QuoteApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://fitnessapp-1274.appspot.com/_ah/api/";
  ...
  public class GetQuote extends QuoteApiRequest<com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(QuoteApi.this, "GET", REST_PATH, null, com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote.class);
   ...
   *
   * @param content the {@link com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteApiRequest<com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote content) {
      super(QuoteApi.this, "POST", REST_PATH, content, com.example.kimjeongyong.myapplication.backend.quoteApi.model.Quote.class);
    }
